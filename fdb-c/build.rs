...
cfg_if::cfg_if! {
    if #[cfg(feature = "fdb_730")] {
const FDB_VERSION : i32 = 730;
    } else if #[cfg(feature = "fdb_710")] {
const FDB_VERSION : i32 = 710;
    } else if #[cfg(feature = "fdb_700")] {
const FDB_VERSION : i32 = 700;
    } else if #[cfg(feature = "fdb_630")] {
const FDB_VERSION : i32 = 630;
    } else if #[cfg(feature = "fdb_620")] {
const FDB_VERSION : i32 = 620;
    } else if #[cfg(feature = "fdb_610")] {
const FDB_VERSION : i32 = 610;
    } else if #[cfg(feature = "fdb_600")] {
const FDB_VERSION : i32 = 600;
    } else if #[cfg(feature = "fdb_520")] {
const FDB_VERSION : i32 = 520;
    } else if #[cfg(feature = "fdb_510")] {
